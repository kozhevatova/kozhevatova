...
:calendar: На данный момент прохожу обучение по специальности "React-разработчик" в Яндекс.Практикуме. Работаю над проектом ["Космическая бургерная"](https://github.com/kozhevatova/react-burger). 

:memo: В планах: 
- попробовать свои силы в open-source проекте
- разработать [интернет-магазин](https://github.com/kozhevatova/online-shop)
